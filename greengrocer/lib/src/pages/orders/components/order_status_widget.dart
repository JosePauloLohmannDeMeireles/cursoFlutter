...
class OrderStatusWidget extends StatelessWidget {
  ...
  OrderStatusWidget({super.key, required this.isOverdue, required this.status});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if(currentStatus == 1) ...[
          const _StatusDot(isActive: true, title: 'Pix estornado', backgroundColor: Colors.amber,)
        ],
        if(isOverdue) ...[
